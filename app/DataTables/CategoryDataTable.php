    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function (Category $category) {
                $html = '<a class="btn btn-link text-info" href="' . route('categories.edit', $category->id) . '"><i class="fa fa-pencil"></i></a>';
            ...
            ->editColumn('parent_id', function (Category $category) {
                if (isset($category->parent->name)) {
                    return '<a href="' . route('categories.edit', $category->parent->id) . '">' . $category->parent->name . '</>';
                }
